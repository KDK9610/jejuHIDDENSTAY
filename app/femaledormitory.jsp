					...
					<div class="row gtr-200">
						<div class="col-8 col-12-medium">
							<!-- Content -->
								<section id="content">
									...
									<a href="#" class="image fit"><img src="images/room/domitory/female1.jpeg" alt="" /></a>
									<h3>히든스테이 여성 도미토리 4인실</h3>
									<p> 개인 여행자들을 위한 공간, 히든스테이 도미토리  </p>
									
									<h3>히든스테이 AMENITIES</h3>
									<ul>
										<li>쾌적하고 깨끗한 도미토리 전용 화장실</li>
										<li>잠을 부르는 2층침대 & 포근한 순면 침구류</li>
										<li>드라이기</li>
										<li>샴푸,바디워시,손세정제</li>
										<li>타월 2종</li>
										<li>생수</li>
						...
						<div class="col-4 col-12-medium">
							...
							<!-- Sidebar -->
								<section id="sidebar">
									<section>
										<h3>히든스테이 여성 4인실 도미토리</h3>
										<p> 성산일출봉 앞 마을 가운데 위치한 히든스테이, <br>
											성산일출봉에서의 일출 도보 1분, 주변에는 광치기 해변, 섭지코지 , 해안도로가 펼쳐져 있다.</p>
										<footer>
											<ul class="actions">
												<li><a href="#" class="button small alt">예약하기</a></li>
											</ul>
										</footer>
									</section>
									<hr />
									<section>
										<a href="#" class="image fit"><img src="images/room/domitory/female2.jpeg" alt="twin2" /></a>
										<a href="#" class="image fit"><img src="images/room/domitory/female3.jpeg " alt="twin3"/></a>
										
										<footer>
											<ul class="actions">
												<li><a href="#" class="button small alt">객실 사진 더보기</a></li>
											</ul>
										</footer>
									</section>
								</section>
