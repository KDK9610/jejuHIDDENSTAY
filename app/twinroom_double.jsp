						...
						<div class="col-8 col-12-medium">
							<!-- Content -->
								<section id="content">
									...
									<a href="#" class="image fit"><img src="images/room/twinroom/double1.jpeg" alt="" /></a>
									<h3>제주에서 보내는 둘만의 시간</h3>
									<p> 2인 여행자들을 위해 설계된 프라이빗한 공간 히든스테이 2인실  </p>
									
									<h3>히든스테이 AMENITIES</h3>
									<ul>
										<li>쾌적하고 깨끗한 2인 전용 화장실</li>
										<li>잠을 부르는 더블베드 & 포근한 순면 침구류</li>
										<li>드라이기</li>
										<li>샴푸,바디워시,손세정제</li>
										<li>타월 2종</li>
										<li>생수</li>
						...
						<div class="col-4 col-12-medium">
							...
							<!-- Sidebar -->
								<section id="sidebar">
									...
									<hr />
									<section>
										<a href="#" class="image fit"><img src="images/room/twinroom/double2.jpeg" alt="twin2" /></a>
										<a href="#" class="image fit"><img src="images/room/twinroom/double3.jpeg" alt="twin3"/></a>
